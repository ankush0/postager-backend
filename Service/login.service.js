        ...
        if (req.body.Platform && req.body.userid.match(/^[0-9a-fA-F]{24}$/) && req.body.Content && req.body.Brand && req.body.Brand.match(/^[0-9a-fA-F]{24}$/)) {
            ...
            if (req.body.Platform.includes("instagram")) {
                ...
                const client = new TwitterApi({
                    appKey: "gEyZrmXfbw6QzO2r9alOFdkHu",
                    appSecret: "uusLyMaKBjxXcptyFeCSOIp421xTxcHUU3fis4QVUPpleqEN80",
                    accessToken: "1670667948590239747-czcBpAgIcCD2tmXNMKtBq9EAptij9E",
                    accessSecret: "QNKt0NY4yGniJXWYjIhYN45OVq6RldnLAMWBo1N6j5oEk",
                  });
